...
public class MutualExclusion {
	...
	private void multicastMessage(Message message, List<Message> activenodes) throws RemoteException {
		...
		for(Message forMessage : activenodes) {
			NodeInterface stub = Util.getProcessStub(forMessage.getNodeIP(), forMessage.getPort());
			stub.onMutexAcknowledgementReceived(forMessage);
		}
	...
	public void onMutexRequestReceived(Message message) throws RemoteException {
		...
		String msgIP = message.getNodeIP();
		// if message is from self, acknowledge, and call onMutexAcknowledgementReceived()
			if(msgIP.equals(node.getNodeName())){
